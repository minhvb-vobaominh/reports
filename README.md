...
- Task WeWork bị `Quá hạn` sẽ **override** các stage còn trong giai đoạn dev → Overdue. Riêng stage đã sang **UAT** thì giữ nguyên UAT (deadline trễ vẫn thể hiện qua `late_days` / `risk_level` trong fact)
